<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <% String id=request.getParameter("id"); 
       String sql ="select * from repas WHERE id ="+id ;
     %>
          <%!
// Basic declarations
...
<html>
  ...
  <body class="text-blueGray-700 antialiased">
            ...
            <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
              ...
              >
				...
				try
					...
					conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/repas_trad","root","");
    ...
    <form  action="<%= request.getContextPath() %>/RepasUpdate?id=<%=resultSet.getString("id") %>" method="post">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="relative w-full mb-3">
                          ...
                          >
                           TITRE 
                            ...
                            name="titre"
                            value="<%=resultSet.getString("titre") %>"
                          />
                        </div>
                      </div>
                       <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          >
                           PRIX
                            ...
                            class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                            name="prix"
                            value="<%=resultSet.getString("prix") %>"
                          />
                        </div>
                      </div>
                      <div class="w-full lg:w-6/12 px-4">
                     ...
                     <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input type="url" 
                          id="img" 
                          value="<%=resultSet.getString("image") %>"
                          name="image"
                          class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                                ><br><br>
