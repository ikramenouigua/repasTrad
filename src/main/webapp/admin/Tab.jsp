<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="java.sql.*" %>
     <%@ page import="dao.RepasDaoImp,dao.RepasDao,dao.DaoFactory, model.Repas,java.util.*" %>
      <%!
// Basic declarations
              ...
              >
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                  <div class="flex flex-wrap items-center">
                    ...
                    >
                      <h3 class="font-semibold text-base text-orange-500">
                       LISTES DES REPAS
                      </h3>
                    </div>
                    <div
        	...
        	%>
                      ...
                      <tr>
                        ...
                        >
                           ...
                           <form action="update.jsp?id=<%=resultSet.getString("id") %>" method="post">
                        ...
                        <td
                          class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4"
                        >
                          <form action="<%= request.getContextPath() %>/RepasDelete?id=<%=resultSet.getString("id") %>" method="post">
