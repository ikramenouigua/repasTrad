...
<html>
  <head>
    ...
    <title>Administrateur du tableau de bord | Bienvenu</title>
  </head>
  <body class="text-blueGray-700 antialiased">
    ...
    <div id="root">
      ...
      style="background-color: rgb(156 163 175);"
        class="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap 
        md:overflow-hidden shadow-xl  flex flex-wrap items-center justify-between relative md:w-64 z-10 py-4 px-6"
      >
        <div
            ...
            class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
              ...
              >
                ...
                <div class="block w-full overflow-x-auto">
                  <!-- Projects table -->
    <form  action="<%= request.getContextPath() %>/RepasServlet" method="post">
                    ...
                    <div class="flex flex-wrap">
                     ...
                     <button
                     style="margin-left:auto;margin-right:auto;display:block;margin-top:10%;margin-bottom:0%"
                      class="bg-orange-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-6 py-4 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150"
