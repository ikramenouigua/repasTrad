...
String URL = "jdbc:mysql://localhost:3306/repas_trad";
  ...
  <body class="text-blueGray-700 antialiased">
    ...
    <div id="root">
      ...
      style="background-color: rgb(156 163 175);"
        class="md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl
    ...
    document.getElementById('luv').style.width = <%=2%> + "%";
    document.getElementById('luv2').style.width = <%=100-2%> + "%";
